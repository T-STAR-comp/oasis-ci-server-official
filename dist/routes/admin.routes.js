...
adminRouter.post("/api/admin/platform-settings", withSession(true), requireRole(["admin"]), validate(z.object({
    ...
    state.auditLog = [
        createAuditEvent(req.user.name, "Platform remediation contact updated", platform.remediationEmail, "Owners use this address to request Oasis CI remediation assistance."),
        ...state.auditLog,
    ];
